...
const ProjectDetails = () => {
  ...
  // This function is no longer needed as we're using the form for invitations
  // Only keeping it as a reference in case it's called elsewhere
  const handleProjectInvitation = () => {
    // Don't send invitations with empty email addresses
    console.log("Please use the invitation form to provide a valid email");
  };
  return (
    <>
      {!project.loading ? (
